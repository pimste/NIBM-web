...
export const translations: Record<Language, Record<string, string>> = {
  ...
  nl: {
    ...
    'about.team.ceo.bio': 'Met meer dan 25 jaar ervaring in de bouwindustrie, richt Egidius (Gid) Gehlen NIBM Tower Cranes op met een visie om betrouwbare en innovatieve kraanoplossingen te bieden.',
  ...
  de: {
    ...
    'contact.info.weekend': 'Samstag - Sonntag: Gesloten',
    'contact.map.title': 'Find Us on the Map',
    'contact.form.select': 'Select a subject',
    'contact.form.sales': 'Sales Inquiry',
    'contact.form.rental': 'Rental Inquiry',
