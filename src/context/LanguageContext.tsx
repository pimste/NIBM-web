...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'services.training.desc': 'Comprehensive equipment condition assessments and site evaluations to ensure optimal crane selection and safe operations.',
    ...
    'about.team.ceo.bio': 'With over 25 years of experience in the construction industry, Egidius (Gid) Gehlen founded NIBM Tower Cranes with a vision to provide reliable and innovative crane solutions.',
    ...
    // Footer
    'footer.description': 'Specialists in the sale and rental of tower cranes, offering a full-service concept including planning, transport, mounting, inspections, and after-sales support.',
    ...
    'services.sale.desc': 'We offer a wide range of used tower cranes for sale that cater to various construction needs and budgets. Each crane comes with comprehensive documentation, warranties, and full technical support.',
    ...
    'services.training.title': 'Equipment Assessment & Site Evaluation',
    'services.training.feature1': 'Comprehensive equipment condition assessments',
    'services.training.feature2': 'Site suitability and access evaluations',
    'services.training.feature3': 'Load capacity and operational feasibility analysis',
    'services.training.feature4': 'Safety compliance and regulatory assessments',
    'services.training.feature5': 'Detailed reporting and recommendations',
  ...
  nl: {
    ...
    'about.team.ceo.bio': 'Met meer dan 25 jaar ervaring in de bouwindustrie, richtte Egidius (Gid) Gehlen NIBM Tower Cranes op met een visie om betrouwbare en innovatieve kraanoplossingen te bieden.',
    ...
    // Footer
    'footer.description': 'Specialisten in de verkoop en verhuur van torenkranen, met een full-service concept inclusief planning, transport, montage, inspecties en after-sales ondersteuning.',
    ...
    'services.step3.desc': 'We bieden doorlopende ondersteuning, onderhoud en evaluatie tijdens de volledige duur van uw project.',
    ...
    'services.sale.desc': 'We bieden een breed scala aan gebruikte torenkranen aan voor verkoop, die voldoen aan verschillende bouwbehoeften en budgetten. Elke kraan wordt geleverd met uitgebreide documentatie, garanties en volledige technische ondersteuning.',
    ...
    'services.training.title': 'Apparatuur Beoordeling & Locatie Evaluatie',
    'services.training.feature1': 'Uitgebreide apparatuur conditie beoordelingen',
    'services.training.feature2': 'Locatie geschiktheid en toegankelijkheid evaluaties',
    'services.training.feature3': 'Draagcapaciteit en operationele haalbaarheid analyse',
    'services.training.feature4': 'Veiligheids compliance en regelgeving beoordelingen',
    'services.training.feature5': 'Gedetailleerde rapportage en aanbevelingen',
  ...
  de: {
    ...
    'about.values.safety.desc': 'Sicherheit ist unsere Priorität in allen Aspekten unserer Geschäftsführung, von der Kranauswahl bis zur Installation und Evaluierung.',
    ...
    'about.team.ceo.bio': 'Mit über 25 Jahren Erfahrung in der Bauindustrie gründete Egidius (Gid) Gehlen NIBM Tower Cranes mit der Vision, zuverlässige und innovative Kranlösungen zu bieten.',
    ...
    // Footer
    'footer.description': 'Spezialisten für den Verkauf und die Vermietung von Turmkranen, mit einem Full-Service-Konzept einschließlich Planung, Transport, Montage, Inspektionen und After-Sales-Support.',
