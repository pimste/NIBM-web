    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-600">Kraan details laden...</p>
        </div>
      </div>
    )
  }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-neutral-50 rounded-lg p-6 mb-6">
                <h3 className="text-lg font-semibold text-neutral-900 mb-4">Technische Specificaties</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <span className="text-sm text-neutral-500">Bouwjaar:</span>
                  ...
                  <div>
                    <span className="text-sm text-neutral-500">Max. Capaciteit:</span>
                    <span className="block font-medium">{crane.maxCapacity}</span>
                  </div>
                  <div>
                    <span className="text-sm text-neutral-500">Max. Gieklengte:</span>
                    <span className="block font-medium">{crane.maxJibLength}</span>
                  </div>
                  <div>
                    <span className="text-sm text-neutral-500">Max. Hoogte:</span>
                    <span className="block font-medium">{crane.maxHeight}</span>
                  </div>
                  {crane.specifications?.manufacturer && (
                    <div>
                      <span className="text-sm text-neutral-500">Fabrikant:</span>
              ...
              {crane.features && crane.features.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-neutral-900 mb-4">Uitrusting</h3>
              ...
              <div className="bg-primary-50 rounded-lg p-6">
                ...
                {formSubmitted ? (
                  <div className="text-center py-4">
                    ...
                    <p className="text-green-600 font-medium">Bedankt voor uw aanvraag!</p>
                    <p className="text-neutral-600 text-sm">We nemen binnenkort contact met u op.</p>
                  </div>
                ) : (
